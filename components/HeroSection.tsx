...
export function HeroSection() {
  return (
    <section id="inicio" className="reveal-section bg-[#0A0A0A] pb-3 md:pb-4 lg:h-264 h-225 md:h-285">
      ...
      <div className="relative mx-3 mt-0 pt-28 flex flex-col overflow-hidden rounded-[28px] md:mx-6 lg:max-w-7xl lg:mx-auto">
        <div className="relative grid gap-6 px-6 pb-10 pt-28 md:grid-cols-[1.4fr_.6fr] md:grid-rows-[1fr] md:flex-1 md:gap-8 md:px-10 md:pt-32 lg:px-14">
          <div className="reveal-item relative z-10 md:mt-0 mt-40 items-center md:items-start flex flex-col w-full justify-center pb-2 md:pb-16">
            ...
            <h1 className="mb-6 font-['Display'] w-full md:text-start text-center text-[30px] font-semibold leading-[1.05] tracking-[-0.02em] text-white md:text-[42px] lg:text-[72px]">
              <span className="block">Seu direito previdenciário</span>
              <em className="block italic text-[#D1AD7D]">tratado com atenção, estratégia e cuidado.</em>
            </h1>
