...
export function ContactSection() {
  return (
    <section id="contato" className="reveal-section bg-[#F3F3F3] px-5.5 py-20 md:px-[max(6vw,40px)] md:py-30">
      <div className="mx-auto grid max-w-7xl gap-14 md:grid-cols-2 md:gap-[clamp(60px,10vw,150px)]">
        <div className="reveal-item">
          ...
          <div className="mt-9.5 grid max-w-130 gap-5.5 border-t border-[#0A0A0A33] pt-7 text-[#0A0A0A]"><div className="grid gap-1.5 md:grid-cols-[160px_1fr] md:gap-3"><span className="text-[11px] font-medium tracking-[1px] text-[#D1AD7D]">TELEFONE</span><Link className="text-[16px] leading-[1.6]" href={`tel:${contactDetails.phoneE164}`}>{contactDetails.phoneDisplay}</Link></div><div className="grid gap-1.5 md:grid-cols-[160px_1fr] md:gap-3"><span className="text-[11px] font-medium tracking-[1px] text-[#D1AD7D]">E-MAIL</span><Link className="text-[16px] leading-[1.6]" href={`mailto:${contactDetails.email}`}>{contactDetails.email}</Link></div><div className="grid gap-1.5 md:grid-cols-[160px_1fr] md:gap-3"><span className="text-[11px] font-medium tracking-[1px] text-[#D1AD7D]">ESCRITÓRIO CENTRAL</span><p className="m-0 text-[16px] leading-[1.6]">{contactDetails.address}</p></div></div>
        </div>
